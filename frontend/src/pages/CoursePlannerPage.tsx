...
const PRESET_COURSES: { name: string; description: string; obstacles: Obstacle[] }[] = [
  ...
  // ═══ Hoopers preset courses ═══
  {
    name: 'Hoopers Startklass (12 hoops)',
    description: 'Startklass-bana med bara hoops och tunnor – DO 4m, ingen tunnel/staket',
    obstacles: [
      { id: 'hs_s', type: 'start', x: 80, y: 560, rotation: 0, label: 'Start', numbers: [], colorNumbers: [] },
      { id: 'hs_1', type: 'hoop', x: 80, y: 480, rotation: 0, label: 'Hoop', numbers: [1], colorNumbers: [{ num: 1, color: '#3b82f6' }] },
      { id: 'hs_2', type: 'hoop', x: 160, y: 420, rotation: 25, label: 'Hoop', numbers: [2], colorNumbers: [{ num: 2, color: '#3b82f6' }] },
      { id: 'hs_3', type: 'hoop', x: 260, y: 380, rotation: -10, label: 'Hoop', numbers: [3], colorNumbers: [{ num: 3, color: '#3b82f6' }] },
      { id: 'hs_4', type: 'hoop', x: 360, y: 340, rotation: 15, label: 'Hoop', numbers: [4], colorNumbers: [{ num: 4, color: '#3b82f6' }] },
      { id: 'hs_5', type: 'hoop', x: 460, y: 300, rotation: 0, label: 'Hoop', numbers: [5], colorNumbers: [{ num: 5, color: '#3b82f6' }] },
      { id: 'hs_6', type: 'hoop', x: 500, y: 220, rotation: -30, label: 'Hoop', numbers: [6], colorNumbers: [{ num: 6, color: '#3b82f6' }] },
      { id: 'hs_7', type: 'barrel', x: 420, y: 160, rotation: 0, label: 'Tunna', numbers: [7], colorNumbers: [{ num: 7, color: '#3b82f6' }], barrelDirection: 'cw' },
      { id: 'hs_8', type: 'hoop', x: 320, y: 120, rotation: 20, label: 'Hoop', numbers: [8], colorNumbers: [{ num: 8, color: '#3b82f6' }] },
      { id: 'hs_9', type: 'hoop', x: 220, y: 100, rotation: 0, label: 'Hoop', numbers: [9], colorNumbers: [{ num: 9, color: '#3b82f6' }] },
      { id: 'hs_10', type: 'barrel', x: 140, y: 160, rotation: 0, label: 'Tunna', numbers: [10], colorNumbers: [{ num: 10, color: '#3b82f6' }], barrelDirection: 'ccw' },
      { id: 'hs_11', type: 'hoop', x: 200, y: 240, rotation: -15, label: 'Hoop', numbers: [11], colorNumbers: [{ num: 11, color: '#3b82f6' }] },
      { id: 'hs_12', type: 'hoop', x: 300, y: 260, rotation: 10, label: 'Hoop', numbers: [12], colorNumbers: [{ num: 12, color: '#3b82f6' }] },
      { id: 'hs_do', type: 'handler_zone', x: 300, y: 400, rotation: 0, label: 'DO', numbers: [], colorNumbers: [] },
      { id: 'hs_f', type: 'finish', x: 380, y: 80, rotation: 0, label: 'Mål', numbers: [], colorNumbers: [] },
    ],
  },
  {
    name: 'Hoopers Klass 1 (16 hinder)',
    description: 'Klass 1-bana med hoops, tunnlar och tunnor – DO 3m, 2 DO, inga staket',
    obstacles: [
      { id: 'hk1_s', type: 'start', x: 60, y: 560, rotation: 0, label: 'Start', numbers: [], colorNumbers: [] },
      { id: 'hk1_1', type: 'hoop', x: 60, y: 480, rotation: 0, label: 'Hoop', numbers: [1], colorNumbers: [{ num: 1, color: '#f59e0b' }] },
      { id: 'hk1_2', type: 'hoop', x: 140, y: 420, rotation: 20, label: 'Hoop', numbers: [2], colorNumbers: [{ num: 2, color: '#f59e0b' }] },
      { id: 'hk1_3', type: 'hoop', x: 240, y: 380, rotation: -10, label: 'Hoop', numbers: [3], colorNumbers: [{ num: 3, color: '#f59e0b' }] },
      { id: 'hk1_4', type: 'hoopers_tunnel', x: 340, y: 360, rotation: 0, label: 'Tunnel', numbers: [4], colorNumbers: [{ num: 4, color: '#f59e0b' }] },
      { id: 'hk1_5', type: 'hoop', x: 440, y: 340, rotation: 15, label: 'Hoop', numbers: [5], colorNumbers: [{ num: 5, color: '#f59e0b' }] },
      { id: 'hk1_6', type: 'barrel', x: 500, y: 270, rotation: 0, label: 'Tunna', numbers: [6], colorNumbers: [{ num: 6, color: '#f59e0b' }], barrelDirection: 'cw' },
      { id: 'hk1_7', type: 'hoop', x: 460, y: 200, rotation: -25, label: 'Hoop', numbers: [7], colorNumbers: [{ num: 7, color: '#f59e0b' }] },
      { id: 'hk1_8', type: 'hoop', x: 380, y: 150, rotation: 0, label: 'Hoop', numbers: [8], colorNumbers: [{ num: 8, color: '#f59e0b' }] },
      { id: 'hk1_9', type: 'hoopers_tunnel', x: 280, y: 120, rotation: 90, label: 'Tunnel', numbers: [9], colorNumbers: [{ num: 9, color: '#f59e0b' }] },
      { id: 'hk1_10', type: 'hoop', x: 200, y: 100, rotation: 10, label: 'Hoop', numbers: [10], colorNumbers: [{ num: 10, color: '#f59e0b' }] },
      { id: 'hk1_11', type: 'barrel', x: 120, y: 140, rotation: 0, label: 'Tunna', numbers: [11], colorNumbers: [{ num: 11, color: '#f59e0b' }], barrelDirection: 'ccw' },
      { id: 'hk1_12', type: 'hoop', x: 160, y: 220, rotation: -15, label: 'Hoop', numbers: [12], colorNumbers: [{ num: 12, color: '#f59e0b' }] },
      { id: 'hk1_13', type: 'hoop', x: 260, y: 240, rotation: 0, label: 'Hoop', numbers: [13], colorNumbers: [{ num: 13, color: '#f59e0b' }] },
      { id: 'hk1_14', type: 'barrel', x: 360, y: 260, rotation: 0, label: 'Tunna', numbers: [14], colorNumbers: [{ num: 14, color: '#f59e0b' }], barrelDirection: 'cw' },
      { id: 'hk1_15', type: 'hoop', x: 420, y: 300, rotation: 20, label: 'Hoop', numbers: [15], colorNumbers: [{ num: 15, color: '#f59e0b' }] },
      { id: 'hk1_16', type: 'hoop', x: 320, y: 300, rotation: -10, label: 'Hoop', numbers: [16], colorNumbers: [{ num: 16, color: '#f59e0b' }] },
      { id: 'hk1_do1', type: 'handler_zone', x: 300, y: 460, rotation: 0, label: 'DO 1', numbers: [], colorNumbers: [] },
      { id: 'hk1_do2', type: 'handler_zone', x: 200, y: 180, rotation: 0, label: 'DO 2', numbers: [], colorNumbers: [] },
      { id: 'hk1_f', type: 'finish', x: 520, y: 80, rotation: 0, label: 'Mål', numbers: [], colorNumbers: [] },
    ],
  },
  {
    name: 'Hoopers Klass 2 (20 hinder)',
    description: 'Klass 2-bana med tunnlar, tunnor, staket och 2 DO (2m) – alla hindertyper',
    obstacles: [
      { id: 'hk2_s', type: 'start', x: 60, y: 560, rotation: 0, label: 'Start', numbers: [], colorNumbers: [] },
      { id: 'hk2_1', type: 'hoop', x: 60, y: 480, rotation: 0, label: 'Hoop', numbers: [1], colorNumbers: [{ num: 1, color: '#8b5cf6' }] },
      { id: 'hk2_2', type: 'hoop', x: 140, y: 420, rotation: 20, label: 'Hoop', numbers: [2], colorNumbers: [{ num: 2, color: '#8b5cf6' }] },
      { id: 'hk2_3', type: 'hoopers_tunnel', x: 240, y: 400, rotation: 0, label: 'Tunnel', numbers: [3], colorNumbers: [{ num: 3, color: '#8b5cf6' }] },
      { id: 'hk2_4', type: 'hoop', x: 340, y: 380, rotation: -15, label: 'Hoop', numbers: [4], colorNumbers: [{ num: 4, color: '#8b5cf6' }] },
      { id: 'hk2_5', type: 'barrel', x: 440, y: 340, rotation: 0, label: 'Tunna', numbers: [5], colorNumbers: [{ num: 5, color: '#8b5cf6' }], barrelDirection: 'cw' },
      { id: 'hk2_6', type: 'hoop', x: 520, y: 280, rotation: 0, label: 'Hoop', numbers: [6], colorNumbers: [{ num: 6, color: '#8b5cf6' }] },
      { id: 'hk2_7', type: 'gate', x: 520, y: 200, rotation: 0, label: 'Staket', numbers: [7], colorNumbers: [{ num: 7, color: '#8b5cf6' }] },
      { id: 'hk2_8', type: 'hoop', x: 460, y: 140, rotation: 30, label: 'Hoop', numbers: [8], colorNumbers: [{ num: 8, color: '#8b5cf6' }] },
      { id: 'hk2_9', type: 'hoop', x: 380, y: 100, rotation: 0, label: 'Hoop', numbers: [9], colorNumbers: [{ num: 9, color: '#8b5cf6' }] },
      { id: 'hk2_10', type: 'hoopers_tunnel', x: 280, y: 80, rotation: 90, label: 'Tunnel', numbers: [10], colorNumbers: [{ num: 10, color: '#8b5cf6' }] },
      { id: 'hk2_11', type: 'barrel', x: 180, y: 100, rotation: 0, label: 'Tunna', numbers: [11], colorNumbers: [{ num: 11, color: '#8b5cf6' }], barrelDirection: 'ccw' },
      { id: 'hk2_12', type: 'hoop', x: 120, y: 160, rotation: -20, label: 'Hoop', numbers: [12], colorNumbers: [{ num: 12, color: '#8b5cf6' }] },
      { id: 'hk2_13', type: 'gate', x: 200, y: 220, rotation: 0, label: 'Staket', numbers: [13], colorNumbers: [{ num: 13, color: '#8b5cf6' }] },
      { id: 'hk2_14', type: 'hoop', x: 300, y: 240, rotation: 10, label: 'Hoop', numbers: [14], colorNumbers: [{ num: 14, color: '#8b5cf6' }] },
      { id: 'hk2_15', type: 'barrel', x: 400, y: 220, rotation: 0, label: 'Tunna', numbers: [15], colorNumbers: [{ num: 15, color: '#8b5cf6' }], barrelDirection: 'cw' },
      { id: 'hk2_16', type: 'hoop', x: 460, y: 280, rotation: 0, label: 'Hoop', numbers: [16], colorNumbers: [{ num: 16, color: '#8b5cf6' }] },
      { id: 'hk2_17', type: 'hoop', x: 380, y: 320, rotation: -25, label: 'Hoop', numbers: [17], colorNumbers: [{ num: 17, color: '#8b5cf6' }] },
      { id: 'hk2_18', type: 'hoop', x: 280, y: 340, rotation: 0, label: 'Hoop', numbers: [18], colorNumbers: [{ num: 18, color: '#8b5cf6' }] },
      { id: 'hk2_19', type: 'hoop', x: 180, y: 320, rotation: 15, label: 'Hoop', numbers: [19], colorNumbers: [{ num: 19, color: '#8b5cf6' }] },
      { id: 'hk2_20', type: 'hoop', x: 100, y: 280, rotation: 0, label: 'Hoop', numbers: [20], colorNumbers: [{ num: 20, color: '#8b5cf6' }] },
      { id: 'hk2_do1', type: 'handler_zone', x: 320, y: 480, rotation: 0, label: 'DO 1', numbers: [], colorNumbers: [] },
      { id: 'hk2_do2', type: 'handler_zone', x: 200, y: 180, rotation: 0, label: 'DO 2', numbers: [], colorNumbers: [] },
      { id: 'hk2_f', type: 'finish', x: 500, y: 60, rotation: 0, label: 'Mål', numbers: [], colorNumbers: [] },
    ],
  },
  {
    name: 'Hoopers Klass 3 (24 hinder)',
    description: 'Avancerad Klass 3-bana med 3 DO (2m), tunnlar, tunnor, staket och maximal variation',
    obstacles: [
      { id: 'hk3_s', type: 'start', x: 40, y: 560, rotation: 0, label: 'Start', numbers: [], colorNumbers: [] },
      { id: 'hk3_1', type: 'hoop', x: 40, y: 480, rotation: 0, label: 'Hoop', numbers: [1], colorNumbers: [{ num: 1, color: '#ef4444' }] },
      { id: 'hk3_2', type: 'hoop', x: 120, y: 430, rotation: 20, label: 'Hoop', numbers: [2], colorNumbers: [{ num: 2, color: '#ef4444' }] },
      { id: 'hk3_3', type: 'hoopers_tunnel', x: 220, y: 420, rotation: 0, label: 'Tunnel', numbers: [3], colorNumbers: [{ num: 3, color: '#ef4444' }] },
      { id: 'hk3_4', type: 'barrel', x: 320, y: 400, rotation: 0, label: 'Tunna', numbers: [4], colorNumbers: [{ num: 4, color: '#ef4444' }], barrelDirection: 'cw' },
      { id: 'hk3_5', type: 'hoop', x: 420, y: 380, rotation: -10, label: 'Hoop', numbers: [5], colorNumbers: [{ num: 5, color: '#ef4444' }] },
      { id: 'hk3_6', type: 'gate', x: 500, y: 340, rotation: 0, label: 'Staket', numbers: [6], colorNumbers: [{ num: 6, color: '#ef4444' }] },
      { id: 'hk3_7', type: 'hoop', x: 540, y: 270, rotation: -30, label: 'Hoop', numbers: [7], colorNumbers: [{ num: 7, color: '#ef4444' }] },
      { id: 'hk3_8', type: 'hoop', x: 500, y: 200, rotation: 0, label: 'Hoop', numbers: [8], colorNumbers: [{ num: 8, color: '#ef4444' }] },
      { id: 'hk3_9', type: 'barrel', x: 440, y: 140, rotation: 0, label: 'Tunna', numbers: [9], colorNumbers: [{ num: 9, color: '#ef4444' }], barrelDirection: 'ccw' },
      { id: 'hk3_10', type: 'hoopers_tunnel', x: 360, y: 100, rotation: 90, label: 'Tunnel', numbers: [10], colorNumbers: [{ num: 10, color: '#ef4444' }] },
      { id: 'hk3_11', type: 'hoop', x: 280, y: 80, rotation: 15, label: 'Hoop', numbers: [11], colorNumbers: [{ num: 11, color: '#ef4444' }] },
      { id: 'hk3_12', type: 'gate', x: 200, y: 100, rotation: 0, label: 'Staket', numbers: [12], colorNumbers: [{ num: 12, color: '#ef4444' }] },
      { id: 'hk3_13', type: 'hoop', x: 120, y: 140, rotation: -20, label: 'Hoop', numbers: [13], colorNumbers: [{ num: 13, color: '#ef4444' }] },
      { id: 'hk3_14', type: 'barrel', x: 60, y: 200, rotation: 0, label: 'Tunna', numbers: [14], colorNumbers: [{ num: 14, color: '#ef4444' }], barrelDirection: 'cw' },
      { id: 'hk3_15', type: 'hoop', x: 140, y: 260, rotation: 25, label: 'Hoop', numbers: [15], colorNumbers: [{ num: 15, color: '#ef4444' }] },
      { id: 'hk3_16', type: 'hoop', x: 240, y: 280, rotation: 0, label: 'Hoop', numbers: [16], colorNumbers: [{ num: 16, color: '#ef4444' }] },
      { id: 'hk3_17', type: 'hoopers_tunnel', x: 340, y: 260, rotation: 0, label: 'Tunnel', numbers: [17], colorNumbers: [{ num: 17, color: '#ef4444' }] },
      { id: 'hk3_18', type: 'hoop', x: 440, y: 240, rotation: -15, label: 'Hoop', numbers: [18], colorNumbers: [{ num: 18, color: '#ef4444' }] },
      { id: 'hk3_19', type: 'gate', x: 480, y: 320, rotation: 0, label: 'Staket', numbers: [19], colorNumbers: [{ num: 19, color: '#ef4444' }] },
      { id: 'hk3_20', type: 'hoop', x: 400, y: 360, rotation: 10, label: 'Hoop', numbers: [20], colorNumbers: [{ num: 20, color: '#ef4444' }] },
      { id: 'hk3_21', type: 'barrel', x: 300, y: 340, rotation: 0, label: 'Tunna', numbers: [21], colorNumbers: [{ num: 21, color: '#ef4444' }], barrelDirection: 'ccw' },
      { id: 'hk3_22', type: 'hoop', x: 200, y: 360, rotation: -10, label: 'Hoop', numbers: [22], colorNumbers: [{ num: 22, color: '#ef4444' }] },
      { id: 'hk3_23', type: 'hoop', x: 120, y: 340, rotation: 0, label: 'Hoop', numbers: [23], colorNumbers: [{ num: 23, color: '#ef4444' }] },
      { id: 'hk3_24', type: 'hoop', x: 60, y: 300, rotation: 20, label: 'Hoop', numbers: [24], colorNumbers: [{ num: 24, color: '#ef4444' }] },
      { id: 'hk3_do1', type: 'handler_zone', x: 300, y: 480, rotation: 0, label: 'DO 1', numbers: [], colorNumbers: [] },
      { id: 'hk3_do2', type: 'handler_zone', x: 160, y: 180, rotation: 0, label: 'DO 2', numbers: [], colorNumbers: [] },
      { id: 'hk3_do3', type: 'handler_zone', x: 420, y: 200, rotation: 0, label: 'DO 3', numbers: [], colorNumbers: [] },
      { id: 'hk3_f', type: 'finish', x: 560, y: 60, rotation: 0, label: 'Mål', numbers: [], colorNumbers: [] },
    ],
  },
];
...
export default function CoursePlannerPage() {
  ...
  // ── Modern editor layout (desktop + landscape mobile) ──
  // Notes: Same state, same handlers, same canvas as before — only chrome is new.
  // Grouped obstacle palette
  const currentObstacleTypes = sportMode === 'agility' ? OBSTACLE_TYPES : HOOPERS_OBSTACLE_TYPES;
  const obstacleGroups: { label: string; types: string[] }[] = sportMode === 'agility'
    ? [
        { label: 'Hopp', types: ['jump', 'long_jump', 'oxer', 'wall', 'tire'] },
        { label: 'Tunnlar', types: ['tunnel'] },
        { label: 'Kontaktfält', types: ['a_frame', 'dog_walk', 'seesaw', 'balance'] },
        { label: 'Övrigt', types: ['weave'] },
        { label: 'Start & Mål', types: ['start', 'finish'] },
      ]
    : [
        { label: 'Hoops', types: ['hoop'] },
        { label: 'Tunnlar & tunnor', types: ['hoopers_tunnel', 'barrel'] },
        { label: 'Staket & zon', types: ['gate', 'handler_zone'] },
        { label: 'Start & Mål', types: ['start', 'finish'] },
      ];

  if (isFullscreen || showLandscapeLayout) {
    const isLocked = selectedObs ? lockedIds.has(selectedObs.id) : false;
    const toggleLock = () => {
      if (!selectedObs) return;
      setLockedIds(prev => {
        const next = new Set(prev);
        if (next.has(selectedObs.id)) next.delete(selectedObs.id); else next.add(selectedObs.id);
        return next;
      });
    };
    ...
    return (
      ...
      <div ref={fullscreenContainerRef} className="fixed inset-0 z-50 bg-[hsl(221,28%,8%)] text-[hsl(210,15%,85%)] flex flex-col">
        ...
        <div className="h-12 shrink-0 flex items-center gap-2 px-2 md:px-3 bg-[hsl(221,28%,10%)] border-b border-[hsl(221,20%,18%)] overflow-x-auto whitespace-nowrap scrollbar-hide">
          ...
          <div className="hidden sm:flex items-center gap-2 min-w-0 shrink-0">
            {editingCourseName ? (
              <input
                ...
                onKeyDown={e => { if (e.key === 'Enter' || e.key === 'Escape') setEditingCourseName(false); }}
                placeholder="Banans namn"
                className="h-7 text-sm font-medium bg-[hsl(221,25%,14%)] border border-[hsl(221,20%,22%)] rounded px-2 w-48 outline-none focus:border-primary"
              />
            ) : (
              <button
                onClick={() => setEditingCourseName(true)}
                className="text-sm font-semibold text-[hsl(210,20%,90%)] hover:text-primary truncate max-w-[200px]"
                title="Redigera banans namn"
              >
                {courseName.trim() || 'Namnlös bana'}
              </button>
            )}
            <span className={`text-[10px] font-medium px-1.5 py-0.5 rounded ${isDirty ? 'bg-amber-500/15 text-amber-400' : 'text-[hsl(210,15%,55%)]'}`}>
              {isDirty ? '● Osparad' : savedLabel}
            </span>
          </div>

          {/* Center: undo/redo, sport toggle */}
          <div className="flex items-center gap-1 ml-3">
            <Tooltip>
              <TooltipTrigger asChild>
                <button onClick={handleUndo} disabled={!canUndo} className="w-8 h-8 inline-flex items-center justify-center rounded-md hover:bg-[hsl(221,20%,18%)] disabled:opacity-30 transition-colors">
                  <Undo2 size={15} />
                </button>
              </TooltipTrigger>
              <TooltipContent side="bottom"><span className="text-xs">Ångra (Ctrl+Z)</span></TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <button onClick={handleRedo} disabled={!canRedo} className="w-8 h-8 inline-flex items-center justify-center rounded-md hover:bg-[hsl(221,20%,18%)] disabled:opacity-30 transition-colors">
                  <RotateCcw size={15} className="scale-x-[-1]" />
                </button>
              </TooltipTrigger>
              <TooltipContent side="bottom"><span className="text-xs">Gör om (Ctrl+Y)</span></TooltipContent>
            </Tooltip>
          </div>

          <div className="w-px h-6 bg-[hsl(221,20%,22%)] mx-1" />

          <div className="flex bg-[hsl(221,25%,14%)] rounded-md p-0.5 border border-[hsl(221,20%,22%)]">
            <button
              onClick={() => setSportMode('agility')}
              className={`px-3 py-1 rounded text-[11px] font-semibold transition-all ${sportMode === 'agility' ? 'bg-primary text-primary-foreground' : 'text-[hsl(210,15%,60%)] hover:text-[hsl(210,15%,80%)]'}`}
            >
              Agility
            </button>
            <button
              onClick={() => setSportMode('hoopers')}
              className={`px-3 py-1 rounded text-[11px] font-semibold transition-all ${sportMode === 'hoopers' ? 'bg-primary text-primary-foreground' : 'text-[hsl(210,15%,60%)] hover:text-[hsl(210,15%,80%)]'}`}
            >
              Hoopers
            </button>
          </div>
          ...
          {sportMode === 'hoopers' && (
            <Select value={String(shokClassIndex)} onValueChange={(v) => setShokClassIndex(Number(v))}>
              <SelectTrigger className="h-8 w-32 text-[11px] bg-[hsl(221,25%,14%)] border-[hsl(221,20%,22%)]">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          {/* Right: zoom, grid/snap, save/load/export */}
          <div className="flex items-center gap-0.5 bg-[hsl(221,25%,14%)] rounded-md border border-[hsl(221,20%,22%)] px-1 h-8">
            <button onClick={() => setZoom(z => Math.max(0.2, z * 0.8))} className="w-6 h-6 inline-flex items-center justify-center rounded hover:bg-[hsl(221,20%,18%)]" title="Zooma ut">
              <ZoomOut size={13} />
            </button>
            <button onClick={fitToScreen} className="px-2 h-6 text-[11px] font-mono font-medium text-[hsl(210,20%,75%)] hover:bg-[hsl(221,20%,18%)] rounded" title="Anpassa till skärm">
              {Math.round(zoom * 100)}%
            </button>
            <button onClick={() => setZoom(z => Math.min(3, z * 1.2))} className="w-6 h-6 inline-flex items-center justify-center rounded hover:bg-[hsl(221,20%,18%)]" title="Zooma in">
              <ZoomIn size={13} />
            </button>
          </div>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={`h-8 px-2 inline-flex items-center gap-1 rounded-md border text-[11px] font-medium transition-colors ${showGrid ? 'bg-primary/15 border-primary/40 text-primary' : 'bg-[hsl(221,25%,14%)] border-[hsl(221,20%,22%)] text-[hsl(210,15%,60%)]'}`}
              >
                Rutnät
              </button>
            </TooltipTrigger>
            <TooltipContent side="bottom"><span className="text-xs">Visa/dölj rutnät</span></TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={`h-8 px-2 inline-flex items-center gap-1 rounded-md border text-[11px] font-medium transition-colors ${snapEnabled ? 'bg-primary/15 border-primary/40 text-primary' : 'bg-[hsl(221,25%,14%)] border-[hsl(221,20%,22%)] text-[hsl(210,15%,60%)]'}`}
              >
                Snap
              </button>
            </TooltipTrigger>
            <TooltipContent side="bottom"><span className="text-xs">Lås till rutnätet (0.5m)</span></TooltipContent>
          </Tooltip>
          ...
          <Dialog open={saveOpen} onOpenChange={setSaveOpen}>
            <DialogTrigger asChild>
              <button
                ...
                className="h-8 px-3 inline-flex items-center gap-1.5 rounded-md bg-primary text-primary-foreground hover:bg-primary/90 disabled:opacity-40 text-[11px] font-semibold transition-colors"
                title="Spara bana (Ctrl+S)"
              >
                <Save size={13} /> Spara
              </button>
            </DialogTrigger>
          ...
          <Dialog open={loadOpen} onOpenChange={setLoadOpen}>
            <DialogTrigger asChild>
              <button
                className="h-8 px-2 inline-flex items-center gap-1 rounded-md bg-[hsl(221,25%,14%)] border border-[hsl(221,20%,22%)] hover:bg-[hsl(221,20%,18%)] text-[11px] font-medium"
                title="Öppna bana eller mall"
              >
                <FolderOpen size={13} /> Öppna
              </button>
            </DialogTrigger>
            <DialogContent className="max-h-[80vh] overflow-y-auto">
              <DialogHeader><DialogTitle className="font-display">Öppna bana</DialogTitle></DialogHeader>
              <div className="mb-4">
                <h3 className="text-xs font-semibold text-muted-foreground mb-2 flex items-center gap-1"><Sparkles size={12} /> Färdiga mallar</h3>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                onClick={exportPDF}
                disabled={obstacles.length === 0}
                className="h-8 px-2 inline-flex items-center gap-1 rounded-md bg-[hsl(221,25%,14%)] border border-[hsl(221,20%,22%)] hover:bg-[hsl(221,20%,18%)] text-[11px] font-medium disabled:opacity-40"
                title="Exportera PDF"
              >
                <Download size={13} /> PDF
              </button>
            </TooltipTrigger>
            <TooltipContent side="bottom"><span className="text-xs">Exportera som PDF</span></TooltipContent>
          </Tooltip>
          ...
          <Tooltip>
            ...
            <TooltipContent side="bottom"><span className="text-xs">{isFullscreen ? 'Avsluta fullskärm' : 'Fullskärm'}</span></TooltipContent>
          </Tooltip>
        </div>
        ...
        <div className="flex-1 min-h-0 flex">
          ...
          <div
            ref={containerRef}
            className="flex-1 min-w-0 overflow-hidden relative bg-[hsl(221,30%,6%)]"
            style={{
              touchAction: 'none',
              backgroundImage: `radial-gradient(circle, hsl(221,20%,14%) 1px, transparent 1px)`,
          ...
          >
            ...
            {/* Selected obstacle floating tunnel-controls (kept for tunnel-specific UX) */}
            {selectedObs && selectedObs.type === 'tunnel' && !numberingMode && (
              <div className="absolute bottom-3 left-1/2 -translate-x-1/2 z-20 bg-[hsl(221,28%,12%)]/95 backdrop-blur-sm border border-[hsl(221,20%,22%)] rounded-lg p-2 shadow-xl flex gap-2 items-center"
                onMouseDown={e => e.stopPropagation()}
                onTouchStart={e => e.stopPropagation()}
              >
                <span className="text-[10px] text-[hsl(210,15%,65%)]">Tunnel</span>
                <button onClick={toggleTunnelLength} className="text-[10px] px-2 py-1 rounded bg-[hsl(221,25%,16%)] border border-[hsl(221,20%,22%)] font-medium">
                  {selectedObs.tunnelLength || 4}m
                </button>
                <div className="flex items-center gap-1">
                  <span className="text-[10px] text-[hsl(210,15%,55%)]">Böj:</span>
                  <button onClick={() => updateTunnelBend(-15)} className="p-1 rounded bg-[hsl(221,25%,16%)] hover:bg-[hsl(221,25%,20%)]"><Minus size={10} /></button>
                  <span className="text-[10px] font-medium w-8 text-center">{selectedObs.bendAngle || 0}°</span>
                  <button onClick={() => updateTunnelBend(15)} className="p-1 rounded bg-[hsl(221,25%,16%)] hover:bg-[hsl(221,25%,20%)]"><Plus size={10} /></button>
                </div>
                    ...
                    <button
                      ...
                      className={`text-[9px] px-1.5 py-0.5 rounded border transition-colors ${
                        (selectedObs.bendAngle || 0) === a
                          ...
                          : 'bg-[hsl(221,25%,16%)] border-[hsl(221,20%,22%)] text-[hsl(210,15%,55%)]'
                      }`}
                    >
                      {a === 0 ? 'Rak' : a === 180 ? 'U' : `${a}°`}
                    </button>
            ...
            {multiSelected.size > 0 && !numberingMode && !selectedObs && (
              <div className="absolute bottom-3 left-1/2 -translate-x-1/2 z-20 bg-[hsl(221,28%,12%)]/95 backdrop-blur-sm border border-primary/40 rounded-lg p-2 shadow-xl flex gap-2 items-center"
                onMouseDown={e => e.stopPropagation()}
                onTouchStart={e => e.stopPropagation()}
              >
                <span className="text-[11px] font-semibold text-primary">{multiSelected.size} markerade</span>
                <button onClick={() => rotateGroup(15)} className="p-1.5 rounded bg-[hsl(221,25%,16%)] hover:bg-[hsl(221,25%,20%)] transition-colors" title="Rotera grupp 15°">
                  <RotateCcw size={14} />
                </button>
                <button onClick={deleteMultiSelected} className="p-1.5 rounded bg-[hsl(221,25%,16%)] hover:bg-destructive/20 text-destructive transition-colors" title="Radera markerade">
                  <Trash2 size={14} />
                </button>
                <button onClick={() => { setMultiSelected(new Set()); setMultiSelectMode(false); }} className="p-1.5 rounded bg-[hsl(221,25%,16%)] hover:bg-[hsl(221,25%,20%)] transition-colors" title="Avmarkera">
                  <X size={14} />
                </button>
              </div>
            )}

            {/* Drawing/numbering mode indicator */}
            {(drawingMode || numberingMode || measureMode) && (
              <div className="absolute top-3 left-3 z-10 bg-[hsl(221,28%,12%)]/95 backdrop-blur-sm border border-primary/40 text-primary text-[11px] font-semibold px-2.5 py-1 rounded-md shadow-lg flex items-center gap-2">
                {drawingMode && <><Pencil size={12} /> Rita förarlinje</>}
                {numberingMode && <><Hash size={12} /> Numrera hinder · Nästa: {nextNumberToAssign}</>}
                {measureMode && <><Ruler size={12} /> Mätverktyg</>}
                <button
                  onClick={() => { setDrawingMode(false); setNumberingMode(false); setMeasureMode(false); }}
          ...
          {!sidebarCollapsed ? (
            <div className="hidden md:flex w-64 shrink-0 bg-[hsl(221,28%,10%)] border-l border-[hsl(221,20%,18%)] flex-col">
              <div className="h-9 shrink-0 px-3 flex items-center justify-between border-b border-[hsl(221,20%,18%)]">
                ...
                <button onClick={() => setSidebarCollapsed(true)} className="text-[hsl(210,15%,55%)] hover:text-[hsl(210,15%,80%)]" title="Dölj panel">
                  <ChevronDown size={14} className="-rotate-90" />
                </button>
              </div>
                ...
                {selectedObs ? (
                  ...
                  <div className="p-3 space-y-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="grid grid-cols-2 gap-1.5">
                        <div className="bg-[hsl(221,25%,14%)] border border-[hsl(221,20%,22%)] rounded px-2 py-1">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-1.5">
                        <input
                          ...
                          disabled={isLocked}
                          className="flex-1 h-8 text-xs text-center bg-[hsl(221,25%,14%)] border border-[hsl(221,20%,22%)] rounded outline-none focus:border-primary disabled:opacity-50"
                        />
                        <span className="text-xs text-[hsl(210,15%,55%)]">°</span>
                        <button
                          onClick={() => !isLocked && rotateSelected()}
                          disabled={isLocked}
                          className="w-8 h-8 inline-flex items-center justify-center rounded bg-[hsl(221,25%,14%)] border border-[hsl(221,20%,22%)] hover:border-primary disabled:opacity-50"
                          title="Rotera 15°"
                        >
                          <RotateCcw size={13} />
                        </button>
                    ...
                    {/* Actions */}
                    <div className="space-y-1 pt-1 border-t border-[hsl(221,20%,18%)]">
                      <div className="text-[10px] font-semibold uppercase tracking-wide text-[hsl(210,15%,45%)]">Åtgärder</div>
                      <div className="grid grid-cols-2 gap-1.5">
                        <button
                          onClick={copySelected}
                          disabled={isLocked}
                          className="h-8 inline-flex items-center justify-center gap-1 rounded bg-[hsl(221,25%,14%)] border border-[hsl(221,20%,22%)] hover:border-primary text-[11px] font-medium disabled:opacity-50"
                        >
                          <Copy size={12} /> Duplicera
                        </button>
                        <button
                          onClick={toggleLock}
                          className={`h-8 inline-flex items-center justify-center gap-1 rounded border text-[11px] font-medium transition-colors ${
                            isLocked
                        ...
                        <button
                          onClick={() => !isLocked && deleteSelected()}
                          disabled={isLocked}
                          className="col-span-2 h-8 inline-flex items-center justify-center gap-1 rounded bg-destructive/10 border border-destructive/30 text-destructive hover:bg-destructive/20 text-[11px] font-semibold disabled:opacity-50"
                        >
                          <Trash2 size={12} /> Radera hinder
                        </button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-3 space-y-3">
                    ...
                    <div className="space-y-1">
                      ...
                      {numberingMode && (
                        <div className="bg-[hsl(221,25%,14%)] border border-[hsl(221,20%,22%)] rounded p-1.5 mt-1">
                      ...
                      {handlerPath.length > 0 && (
                        <button
                          ...
                          className="w-full h-7 inline-flex items-center justify-center gap-1 rounded bg-[hsl(221,25%,14%)] border border-[hsl(221,20%,22%)] hover:border-destructive/40 text-destructive text-[10px] font-medium"
                        >
                          <Eraser size={11} /> Rensa förarlinje
                        </button>
                      )}
                    </div>
                    ...
                    <div className="space-y-1 pt-1 border-t border-[hsl(221,20%,18%)]">
                      ...
                      >
                        <SelectTrigger className="h-8 text-[11px] bg-[hsl(221,25%,14%)] border-[hsl(221,20%,22%)]">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          {CANVAS_SIZES.map(s => (
                      ...
                      <div className="space-y-1 pt-1 border-t border-[hsl(221,20%,18%)]">
                        ...
                        <div className="grid grid-cols-2 gap-1.5">
                          <div className="bg-[hsl(221,25%,14%)] border border-[hsl(221,20%,22%)] rounded px-2 py-1.5">
                            ...
                            <div className="text-sm font-semibold text-[hsl(210,20%,90%)]">{courseStats.total}</div>
                          </div>
                          <div className="bg-[hsl(221,25%,14%)] border border-[hsl(221,20%,22%)] rounded px-2 py-1.5">
                            <div className="text-[9px] text-[hsl(210,15%,50%)]">Längd</div>
                            <div className="text-sm font-semibold text-[hsl(210,20%,90%)]">~{Math.round(courseStats.length)}m</div>
                          </div>
                          {courseStats.contactCount > 0 && (
                            <div className="bg-[hsl(221,25%,14%)] border border-[hsl(221,20%,22%)] rounded px-2 py-1.5 col-span-2">
                              <div className="text-[9px] text-[hsl(210,15%,50%)]">Kontaktfält</div>
                              <div className="text-sm font-semibold text-[hsl(210,20%,90%)]">{courseStats.contactCount}</div>
                            </div>
                          )}
                        </div>
                        ...
                        {sportMode === 'hoopers' && courseStats.recommendedClasses.length === 0 && courseStats.total > 0 && (
                          <div className="text-[9px] text-destructive font-medium mt-1">❌ Passar ingen SHoK-klass</div>
                        )}
                      </div>
                    )}
                    ...
                    {/* Empty state hint */}
                    {obstacles.length === 0 && (
                      <div className="bg-[hsl(221,25%,14%)] border border-dashed border-[hsl(221,20%,28%)] rounded-lg p-3 text-center">
                        <Sparkles size={18} className="mx-auto mb-1 text-[hsl(210,15%,55%)]" />
                        <div className="text-[11px] text-[hsl(210,15%,65%)]">Lägg till hinder från panelen till vänster, eller öppna en mall.</div>
                      </div>
                    )}
                  </div>
                )}
        ...
        <div className="h-7 shrink-0 flex items-center gap-3 px-3 bg-[hsl(221,28%,10%)] border-t border-[hsl(221,20%,18%)] text-[10px] text-[hsl(210,15%,55%)] overflow-x-auto whitespace-nowrap scrollbar-hide">
          ...
          {handlerPath.length > 0 && (<><span className="text-[hsl(221,20%,22%)]">|</span><span>Förarlinje aktiv</span></>)}
          <div className="flex-1" />
          <span className={snapEnabled ? 'text-primary' : ''}>Snap: {snapEnabled ? 'PÅ' : 'AV'}</span>
          <span className="text-[hsl(221,20%,22%)]">|</span>
          <span className={showGrid ? 'text-primary' : ''}>Rutnät: {showGrid ? 'PÅ' : 'AV'}</span>
          <span className="text-[hsl(221,20%,22%)]">|</span>
