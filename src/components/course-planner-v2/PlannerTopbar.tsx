  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="h-9 min-w-0 flex-1 max-w-[280px] sm:max-w-[320px] px-3 rounded-full border border-black/10 bg-white text-sm font-semibold outline-none focus:ring-2 focus:ring-[#1a6b3c]/25"
      />
