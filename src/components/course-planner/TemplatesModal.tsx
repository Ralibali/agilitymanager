...
const BUILTIN_TEMPLATES: CourseTemplate[] = [
  ...
  },
  {
    ...
    obstacles: [
      ...
      { key: 'tunnel', xM: 22, yM: 10, rotation: 0 },
      { key: 'jump', xM: 30, yM: 14, rotation: 90 },
      { key: 'jump', xM: 30, yM: 22, rotation: 90 },
      { key: 'tunnel', xM: 22, yM: 28, rotation: 0 },
  ...
  },
  {
    ...
    obstacles: [
      ...
      { key: 'tunnel', xM: 20, yM: 10, rotation: 0 },
      { key: 'aframe', xM: 30, yM: 12, rotation: 0 },
      { key: 'jump', xM: 40, yM: 14, rotation: 45 },
      { key: 'weave', xM: 38, yM: 22, rotation: 0 },
      ...
      { key: 'tunnel', xM: 14, yM: 18, rotation: 90 },
