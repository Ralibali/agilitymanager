...
const COLS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "SAgiK", href: "https://www.agilityklubben.se", external: true },
      { label: "SHoK", href: "https://www.svenskahoopersklubben.se", external: true },
      { label: "Agilitydata.se", href: "https://www.agilitydata.se", external: true },
