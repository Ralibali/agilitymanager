...
const PRESET_COURSES: { name: string; description: string; obstacles: Obstacle[] }[] = [
  ...
  {
    name: 'Hoopers Startklass (10 hinder)',
    description: 'Grundläggande hoopers-bana med hoops och tunnor – ingen tunnel eller staket',
    obstacles: [
      { id: 'hs_s', type: 'start', x: 100, y: 560, rotation: 0, label: 'Start', numbers: [], colorNumbers: [] },
      { id: 'hs_1', type: 'hoop', x: 100, y: 480, rotation: 0, label: 'Hoop', numbers: [1], colorNumbers: [{ num: 1, color: '#3b82f6' }] },
      { id: 'hs_2', type: 'hoop', x: 200, y: 420, rotation: 30, label: 'Hoop', numbers: [2], colorNumbers: [{ num: 2, color: '#3b82f6' }] },
      { id: 'hs_3', type: 'barrel', x: 300, y: 380, rotation: 0, label: 'Tunna', numbers: [3], colorNumbers: [{ num: 3, color: '#3b82f6' }] },
      { id: 'hs_4', type: 'hoop', x: 400, y: 340, rotation: -15, label: 'Hoop', numbers: [4], colorNumbers: [{ num: 4, color: '#3b82f6' }] },
      { id: 'hs_5', type: 'hoop', x: 480, y: 280, rotation: 0, label: 'Hoop', numbers: [5], colorNumbers: [{ num: 5, color: '#3b82f6' }] },
      { id: 'hs_6', type: 'barrel', x: 400, y: 200, rotation: 0, label: 'Tunna', numbers: [6], colorNumbers: [{ num: 6, color: '#3b82f6' }] },
      { id: 'hs_7', type: 'hoop', x: 300, y: 160, rotation: 20, label: 'Hoop', numbers: [7], colorNumbers: [{ num: 7, color: '#3b82f6' }] },
      { id: 'hs_8', type: 'hoop', x: 200, y: 120, rotation: 0, label: 'Hoop', numbers: [8], colorNumbers: [{ num: 8, color: '#3b82f6' }] },
      { id: 'hs_9', type: 'barrel', x: 140, y: 200, rotation: 0, label: 'Tunna', numbers: [9], colorNumbers: [{ num: 9, color: '#3b82f6' }] },
      { id: 'hs_10', type: 'hoop', x: 200, y: 280, rotation: -30, label: 'Hoop', numbers: [10], colorNumbers: [{ num: 10, color: '#3b82f6' }] },
      { id: 'hs_do', type: 'handler_zone', x: 280, y: 280, rotation: 0, label: 'DO', numbers: [], colorNumbers: [] },
      { id: 'hs_f', type: 'finish', x: 300, y: 100, rotation: 0, label: 'Mål', numbers: [], colorNumbers: [] },
    ],
  },
  {
    name: 'Hoopers Klass 1 (14 hinder)',
    description: 'Klass 1-bana med tunnel, 2 dirigeringszoner och varierade hinder',
    obstacles: [
      { id: 'hk1_s', type: 'start', x: 80, y: 560, rotation: 0, label: 'Start', numbers: [], colorNumbers: [] },
      { id: 'hk1_1', type: 'hoop', x: 80, y: 480, rotation: 0, label: 'Hoop', numbers: [1], colorNumbers: [{ num: 1, color: '#8b5cf6' }] },
      { id: 'hk1_2', type: 'hoop', x: 160, y: 420, rotation: 25, label: 'Hoop', numbers: [2], colorNumbers: [{ num: 2, color: '#8b5cf6' }] },
      { id: 'hk1_3', type: 'barrel', x: 260, y: 400, rotation: 0, label: 'Tunna', numbers: [3], colorNumbers: [{ num: 3, color: '#8b5cf6' }] },
      { id: 'hk1_4', type: 'hoopers_tunnel', x: 360, y: 380, rotation: 0, label: 'Tunnel', numbers: [4], colorNumbers: [{ num: 4, color: '#8b5cf6' }] },
      { id: 'hk1_5', type: 'hoop', x: 460, y: 340, rotation: -20, label: 'Hoop', numbers: [5], colorNumbers: [{ num: 5, color: '#8b5cf6' }] },
      { id: 'hk1_6', type: 'hoop', x: 500, y: 260, rotation: 0, label: 'Hoop', numbers: [6], colorNumbers: [{ num: 6, color: '#8b5cf6' }] },
      { id: 'hk1_7', type: 'barrel', x: 440, y: 180, rotation: 0, label: 'Tunna', numbers: [7], colorNumbers: [{ num: 7, color: '#8b5cf6' }] },
      { id: 'hk1_8', type: 'hoop', x: 360, y: 140, rotation: 30, label: 'Hoop', numbers: [8], colorNumbers: [{ num: 8, color: '#8b5cf6' }] },
      { id: 'hk1_9', type: 'hoop', x: 280, y: 100, rotation: 0, label: 'Hoop', numbers: [9], colorNumbers: [{ num: 9, color: '#8b5cf6' }] },
      { id: 'hk1_10', type: 'barrel', x: 200, y: 140, rotation: 0, label: 'Tunna', numbers: [10], colorNumbers: [{ num: 10, color: '#8b5cf6' }] },
      { id: 'hk1_11', type: 'hoop', x: 140, y: 200, rotation: -15, label: 'Hoop', numbers: [11], colorNumbers: [{ num: 11, color: '#8b5cf6' }] },
      { id: 'hk1_12', type: 'hoopers_tunnel', x: 100, y: 280, rotation: 90, label: 'Tunnel', numbers: [12], colorNumbers: [{ num: 12, color: '#8b5cf6' }] },
      { id: 'hk1_13', type: 'hoop', x: 180, y: 320, rotation: 10, label: 'Hoop', numbers: [13], colorNumbers: [{ num: 13, color: '#8b5cf6' }] },
      { id: 'hk1_14', type: 'hoop', x: 280, y: 280, rotation: 0, label: 'Hoop', numbers: [14], colorNumbers: [{ num: 14, color: '#8b5cf6' }] },
      { id: 'hk1_do1', type: 'handler_zone', x: 300, y: 440, rotation: 0, label: 'DO 1', numbers: [], colorNumbers: [] },
      { id: 'hk1_do2', type: 'handler_zone', x: 200, y: 220, rotation: 0, label: 'DO 2', numbers: [], colorNumbers: [] },
      { id: 'hk1_f', type: 'finish', x: 360, y: 60, rotation: 0, label: 'Mål', numbers: [], colorNumbers: [] },
    ],
  },
];
